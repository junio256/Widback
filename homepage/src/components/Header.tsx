...
export function Header() {
  return (
    <>
      <div className='fixed top-0 z-50 m-auto w-screen flex flex-1 flex-col  justify-center bg-[rgba(255,255,255,0.95)] dark:bg-[rgba(22,19,32,0.95)]'>
        <div id="header" className="py-6 container mx-auto flex justify-between items-center px-28  ">


          <button
            className="text-TextDark-900 dark:text-TextLight-100 flex font-source font-bold pr-8 text-2xl">
            <img className='bg-brand-500 rounded-lg mr-2' src={feedgetLogo} alt="" />
            Feedget
          </button>


          <div className="text-zinc-800 dark:text-TextLight-400 text-lg font-source ">
          ...
          <div className="flex items-center shadow-md bg-brand-500 rounded-lg">
