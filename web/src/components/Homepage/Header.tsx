  ...
  return (
    <>
      <div className='fixed top-0 z-50 m-auto w-screen flex flex-col  justify-center bg-[rgba(255,255,255,0.95)] dark:bg-[rgba(22,19,32,0.95)]'>
        <div id="header" className="py-6 container mx-auto lg:mx-auto sm:mx-0 flex justify-between items-center px-28  ">
          ...
          <div className="text-zinc-800 dark:text-TextLight-400 text-lg font-source sm:invisible lg:visible ">
          ...
          <div className="flex items-center shadow-md bg-brand-500 rounded-lg sm:invisible lg:visible">
            ...
            <a target="_blank" href="https://linkedin.com/in/juniokoi" ><img src={linkedin} alt="" /></a>
